      ...
      {!newsArticles.length ? (
        <div className={classes.footer}>
          <Typography variant="body1" component="h2">
            Created by
            <a className={classes.link} href="https://www.linkedin.com/in/mohit-sisodia-3aa66919a/"> Mohit Sisodia</a> -
            <a className={classes.link} href="https://blog-it.in/"> BLOG IT</a>
          </Typography>
